...
const PRESET_JUDGES = [
  'J01 — คุณ ฐาปนี จอมทอง',
  'J02 — คุณ น้ำฝน มาเยอะ',
  'J03 — คุณ เอมจิรา ใจสุทธิ',
  'J04 — คุณ อรสิริพิมพ์ ตรีระพงศ์',
  'J05 — คุณ ธนากร วงค์จันทร์',
  'J06 — คุณ ยิ้มหวาน',
  'J07 — คุณ สุจิตรา บุญเจริญ',
  'J08 — คุณ วิรัชฎาภรณ์ สุภาพ',
];
